...
const{InputField:InputField}=require("./input-field.js");module.exports.InputFieldObject=class extends InputField{constructor(){super(),this.defaultOptions={...this.defaultOptions,representant:"",subform:{}},this.collapsed=!1}collapseObjectGroupHandler(e){let t=e.srcElement,o=t.parentElement.parentElement,i=void 0,s="";try{i=o.getModel(),s=`${o.options.label} ${i?o.options.representant?i[o.options.representant]?i[o.options.representant]:"":Object.values(i)[0]:""}`}catch(e){console.log("SourceTree")}let n=o.querySelector(`label[for="${o.options.name}"]`),l=o.querySelector(`#${o.options.name}`);o.collapsed?(l.classList.remove("hidden"),t.innerText="einklappen",o.collapsed=!o.collapsed,n.innerText=o.options.label||""):(l.classList.add("hidden"),t.innerText="ausklappen",o.collapsed=!o.collapsed,n.innerText=s)}applyTemplate(){this.rootElement.insertAdjacentHTML("beforeend",`\n          <div class="form-element">\n              <button class="form-object-collapse" type="button" tabIndex="-1">einklappen</button>\n              <label for="${this.options.name}">${this.options.label||""}</label><br>\n              <div id="${this.options.name}" class="form-group">\n                  ${Object.keys(this.options.subform).map(e=>{let t=this.options.subform[e];return`\n                          <${this.mapFieldType(t.feldtyp)} \n                              ${Object.keys(t).map(e=>`${e}='${this.saveValue(e,t[e])}'`).join(" ")}\n                              ${this.options.initialModel&&this.options.initialModel[t.name]?`initialModel='${this.saveValue("initialModel",this.options.initialModel[t.name])}'`:""} \n                          ></${this.mapFieldType(t.feldtyp)}>`}).join("\n")}\n              </div>\n          </div>\n      `),this.querySelector("button.form-object-collapse").addEventListener("click",this.collapseObjectGroupHandler)}applyFocusPriority(){try{console.log(Object.keys(this.options.subform).map(e=>this.options.subform[e].focusPrioritaet?this.options.subform[e].focusPrioritaet:0));let e=Math.max(...Object.keys(this.options.subform).map(e=>this.options.subform[e].focusPrioritaet?this.options.subform[e].focusPrioritaet:0)),t=[...this.querySelectorAll(".form-element > .form-group > *")],o=t.filter(t=>t.options.focusPrioritaet===e);console.log({maxPrio:e,maxPrioElements:o,children:t}),o.length>0?o[0].applyFocusPriority():t[0].applyFocusPriority()}catch(e){console.error(e)}}getModel(){let e={};return[...this.querySelector(`#${this.options.name}`).children].forEach(t=>{let o=t.getModel();o&&(e[JSON.parse(t.getAttribute("name"))]=o)}),0===Object.keys(e).length?void 0:e}checkValidity(){let e=!0;return[...this.querySelector(`#${this.options.name}`).children].forEach(t=>{let o=t.checkValidity();o||console.log(t),e=e&&o}),e}};
